...
ax = df['Score'].value_counts().sort_index().plot(kind = 'bar',
                                                  title = 'Número de Reviews por Nota',
                                                  figsize = (10, 5))
ax.set_xlabel('Nota')
plt.show()
```
...
Um pouco lento pois desta forma está rodando apenas na CPU, mas o modelo Roberta tem implementação otimizada para rodar com a GPU.
